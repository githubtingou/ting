...
public class EntityUtil {
    ...
    private final String author = "tingOu";
    /**
    ...
    private final String url = "jdbc:mysql://localhost:3306/testboot?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone = GMT";
